...
public class Shade {
	...
	public static BufferedImage fromTop (BufferedImage img)
	{
		...
		for ( int i = 0, k = 0, colorValue = 170; i < h; )
		{
			if (colorValue < 0 )
				colorValue = 0;
	...
	public static BufferedImage fromBottom (BufferedImage img)
	{
		...
		for ( int i = 0, k = 0, colorValue = 0; i < h; )
		{
			if (colorValue > 171 )
				colorValue = 171;
			Color col = new Color(colorValue, colorValue, colorValue, 200);
	...
	public static BufferedImage fromRight (BufferedImage img)
	{
		...
		for ( int i = 0, k = 0, colorValue = 0; i < w; )
		{
			if (colorValue > 171 )
				colorValue = 171;
			Color col = new Color(colorValue, colorValue, colorValue, 200);
	...
	public static BufferedImage fromLeft (BufferedImage img)
	{
		...
		for ( int i = 0, k = 0, colorValue = 170; i < w; )
		{
			if (colorValue < 0 )
				colorValue = 0;
			Color col = new Color(colorValue, colorValue, colorValue, 200);
	...
	public static BufferedImage fromBottomRight (BufferedImage img)
	{
		...
		for ( int x1 = 0, y1 = h, x2 = w, y2 = 0, k = 0, colorValue = 85; x2 >= 0 && y1 >= 0; )
		{
			if (colorValue < 0 )
				colorValue = 0;
			Color col = new Color(colorValue, colorValue, colorValue, 200);
		...
		for ( int x1 = 0, y1 = h, x2 = w, y2 = 0, k = 0, colorValue = 86; x1 < w && y2 < h; )
		{
			if (colorValue > 171 )
				colorValue = 171;
			Color col = new Color(colorValue, colorValue, colorValue, 200);
	...
	public static BufferedImage fromTopLeft (BufferedImage img)
	{
		...
		for ( int x1 = 0, y1 = 0, x2 = w, y2 = h, k = 0, colorValue = 85; x2 >= 0 && y1 < h; )
		{
			if (colorValue < 0 )
				colorValue = 0;
			Color col = new Color(colorValue, colorValue, colorValue, 200);
		...
		for ( int x1 = 0, y1 = 0, x2 = w, y2 = h, k = 0, colorValue = 86; x1 < w && y2 >= 0; )
		{
			if (colorValue > 171 )
				colorValue = 171;
			Color col = new Color(colorValue, colorValue, colorValue, 200);
	...
	public static BufferedImage fromBottomLeft (BufferedImage img)
	{
		...
		for ( int x1 = 0, y1 = 0, x2 = w, y2 = h, k = 0, colorValue = 86; x2 >= 0 && y1 < h; )
		{
			if (colorValue > 171 )
				colorValue = 171;
			Color col = new Color(colorValue, colorValue, colorValue, 200);
		...
		for ( int x1 = 0, y1 = 0, x2 = w, y2 = h, k = 0, colorValue = 85; x1 < w && y2 >= 0; )
		{
			if (colorValue < 0 )
				colorValue = 0;
			Color col = new Color(colorValue, colorValue, colorValue, 200);
